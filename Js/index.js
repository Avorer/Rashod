...
const driversData = [
    ...
    { 
        name: "РУСЛАН 14", 
        car: "ВАЗ-2114", 
        time_ivanovskoe_forward: "3:35.0", time_ivanovskoe_reverse: "3:31.0",
        time_glubokoe_forward: null, time_glubokoe_reverse: null,
        time_raifa_forward: null, time_raifa_reverse: null,
        active: true, 
...
function updateLeaderboard() {
    ...
    data.forEach((driver, index) => {
        ...
        const statusClass = driver.active ? 'racer-status-green' : 'racer-status-red';
        const statusText = driver.active ? 'АКТИВЕН' : 'НЕ АКТИВЕН';
